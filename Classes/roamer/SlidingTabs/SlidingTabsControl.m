...
- (id) initWithTabCount:(NSUInteger)tabCount withWidth:(CGFloat )frameWidth
                   delegate:(NSObject <SlidingTabsControlDelegate>*)slidingTabsControlDelegate 
{
    if ((self = [super init]))
    {
        ...
        // Set our frame
        self.frame = CGRectMake(0, 44, frameWidth, 44);
        ...
        CGFloat buttonWidth = (frameWidth / tabCount);
...
- (void)drawRect:(CGRect)rect
{
    ...
    CGFloat components[8] = { 80.0/255.0f, 80.0/255.0f, 80.0/255.0f, 1.0,  // Start color
                              44.0/255.0f, 44.0/255.0f, 44.0/255.0f, 1.0 }; // End color
    ...
    for (int i = 0; i < [_buttons count]; i++) {
        CGFloat buttonWidth = (_frameWidth / [_buttons count]);
        ...
        CGContextAddLineToPoint(context, buttonWidth * i, 44.0);
...
- (void)touchUpInsideAction:(UIButton*)button
{
    ...
    CGFloat buttonWidth = (_frameWidth / segmentCount);
